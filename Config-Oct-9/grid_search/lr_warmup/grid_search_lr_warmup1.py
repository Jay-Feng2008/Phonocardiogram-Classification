...
warmup_all = [1000, 2000, 4000, 6000, 8000]
lrc_all = [0.25, 0.125, 0.1, 0.05, 0.01, 0.005, 0.001]
epochs = [1000, 1000, 1000, 1500, 2000]
earlyStoppingStartEpoch = [300, 300, 300, 450, 600]
